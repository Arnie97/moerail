...
var restrictions = [
    6, '<span style="font-family: serif;">△</span>',
    16, '<span style="border: black solid 1px;">G</span>',
    1, '<span style="font-weight: bold; border-bottom: black solid 1px;">{1}</span>',
    2, '<span style="font-family: serif;">⊗</span>',
    4, '<span style="font-family: serif;">※</span>',
    8, '<span style="text-decoration: line-through;">{1}</span>',
];
